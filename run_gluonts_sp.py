...
if __name__ == "__main__":
    ...
    for data_forms in form_sets:
        ...
        if original_target:
            a,c,p = run_measurements(X, y, chunk_size, dataset_name, model_name, num_runs=num_runs)
        else: #fd target
            a,c,p = run_measurements(X, y, chunk_size, dataset_name, model_name, num_runs=num_runs, d=0.2 , thresh=1e-5 )

        ####################################### Save Results and Visualizations ###############################################################################

        import os
        base_dir = '/mnt/c/Users/resha/Documents/Github/balancing_framework/results/gluonts_sp_stream_runs'
        series_num = 1
        run_title = 'run5'
        dir_ext = f'{dataset_name}_{run_title}_{series_num}_{data_forms}_chunk_size={chunk_size}_num_runs={num_runs}_{model_name}'
